...
export default function Home() {
  ...
  const productCategories = [
    {
      ...
      products: [
        ...
        { id: 3, name: 'Sukuna LED Sign', img: '/sukuna.png', price: 1199 },
        { id: 4, name: 'Spider-Man LED Sign', img: '/spider.png', price: 1149 },
    ...
    },
    {
      ...
      products: [
        ...
        { id: 8, name: 'Crystal Lamp', img: '/crystal lamp .jpg', price: 1099 }, // প্রাইস দেওয়া ছিল না, তাই ১০৯৯ সেট করা হয়েছে
      ],
    },
    {
  ...
  if (showSlip) {
    return (
      <main className="min-h-screen bg-black flex items-center justify-center p-6 text-white font-sans">
        <div className="bg-zinc-900 p-8 rounded-3xl border border-orange-500 w-full max-w-md shadow-2xl overflow-hidden relative">
          
          {/* Background Logo Watermark for Slip */}
          <img 
            ...
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[30vh] opacity-10 pointer-events-none z-0"
          />

          <img src="/ideogram-v3.0_A_modern_minimalist_logo_for_an_e-commerce_brand_named_TrendyCart_BD_._The_logo_-0 (1).jpg" alt="TechnoMartBD" className="h-12 mx-auto mb-6 relative z-10" />
          <div className="border-b border-zinc-800 pb-4 mb-4 text-center relative z-10">
          ...
          <button onClick={() => window.print()} className="w-full mt-8 bg-orange-600 py-3 rounded-xl font-bold transition hover:bg-orange-700 relative z-10">স্লিপ ডাউনলোড করুন</button>
          <button onClick={() => setShowSlip(false)} className="w-full mt-2 text-zinc-500 text-sm hover:underline relative z-10">হোমে ফিরে যান</button>
        </div>
      </main>
    );
  }
  ...
  return (
    <main className="min-h-screen bg-black text-white font-sans selection:bg-orange-500 scroll-smooth relative overflow-hidden">
      ...
      {/* Background Logo Watermark for Landing Page */}
      <img 
        src="/ideogram-v3.0_A_modern_minimalist_logo_for_an_e-commerce_brand_named_TrendyCart_BD_._The_logo_-0 (1).jpg" 
        alt="TechnoMartBD Watermark" 
      ...
      <header className="py-20 text-center bg-zinc-900/30 border-b border-zinc-800 z-10 relative">
        ...
        <div className="mt-8">
          <a href="#products" className="bg-orange-600 hover:bg-orange-700 text-white px-8 py-3 rounded-full font-bold transition shadow-lg shadow-orange-600/30">অর্ডার শুরু করুন</a>
        </div>
      </header>
      ...
      <section id="order" className="bg-zinc-900/50 py-20 px-6 z-10 relative">
        <div className="max-w-xl mx-auto bg-black p-10 rounded-[40px] border border-zinc-800 shadow-2xl overflow-hidden relative">
          ...
          {/* Background Logo Watermark for Checkout */}
          <img 
            src="/ideogram-v3.0_A_modern_minimalist_logo_for_an_e-commerce_brand_named_TrendyCart_BD_._The_logo_-0 (1).jpg" 
            alt="TechnoMartBD Watermark" 
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[50vh] opacity-10 pointer-events-none z-0"
          />
